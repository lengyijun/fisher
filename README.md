...
```console
curl -sL https://raw.githubusercontent.com/lengyijun/fisher/fishest/functions/fisher.fish | source && fisher install lengyijun/fisher --overwrite ; fisher ignore jorgebucaran/fisher
```
-----
